  ...
  if(EXIV2_VERSION_GOOD_FOUND)
   ...
   if (EXIV2_FOUND)
     ...
     find_library_with_debug(EXIV2_LIBRARIES
        ...
        PATHS ${SYSTEM_LIB_DIRS} ${SOURCE_BASE_DIR}/exiv2/msvc/lib ${SOURCE_BASE_DIR}/exiv2-0.16/msvc/lib ${SOURCE_BASE_DIR}/exiv2-0.18/msvc/lib ${SOURCE_BASE_DIR}/exiv2-0.18.1/msvc/lib ${SOURCE_BASE_DIR}/exiv2-0.18.2/msvc/lib
     )
