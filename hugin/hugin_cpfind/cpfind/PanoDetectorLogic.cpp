...
bool PanoDetector::AnalyzeImage(ImgData& ioImgInfo, const PanoDetector& iPanoDetector)
{
    ...
    try
    {
        ...
        TRACE_IMG("Load image " << ioImgInfo._name << "...");
...
bool PanoDetector::RansacMatchesInPairCam(MatchData& ioMatchData, const PanoDetector& iPanoDetector)
{
    ...
    {
        TRACE_PAIR("Has enough matches for MinimumMatches");
    }
    ...
    {
        TRACE_PAIR("Has enough matches for RANSAC filtering.");
    }
    ...
    std::vector<int> inliers;
    {
        ...
        TRACE_PAIR("Creating control points");
    ...
    */
    TRACE_PAIR("Done RANSAC filtering");
    return true;
}
...
void PanoDetector::writeOutput()
{
    ...
    cout << "The output file path is: " << _outputFile << endl;
